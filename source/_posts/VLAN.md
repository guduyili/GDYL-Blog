...
#### **5.2 [IEEE 802.1Q](http://zh.wikipedia.org/wiki/IEEE_802.1Q )**
 ...
 在数据帧中添加了4字节的内容，那么CRC值自然也会有所变化。这时数据帧上的CRC是插入TPID、TCI后，对包括它们在内的整个数据帧重新计算后所得的值。
  ...
  ![](https://img-blog.csdn.net/20130726175307937 )
...
#### **5.3 ISL（Inter Switch Link）**
 ...
 在使用ISL的环境下，当数据帧**离开**汇聚链路时，只要简单地**去除**ISL包头和新CRC就可以了。由于原先的数据帧及其CRC都被完整保留，因此无需重新计算CRC。
  ...
  ![](https://img-blog.csdn.net/20130726175338265 )
...
#### **6.2 使用路由器进行VLAN间路由**
 ...
 ![](https://img-blog.csdn.net/20130726175433375 )
 ...
 ![](https://img-blog.csdn.net/20130726175513765 )
...
#### **6.3 同一VLAN内的通信**
 ...
 ![](https://img-blog.csdn.net/20130726175604515 )
...
| :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: | :------------: |
 ...
 ![](https://img-blog.csdn.net/20130726175623656 )
...
#### **6.4 不同VLAN间的通信**
 ...
 ![](https://img-blog.csdn.net/20130726175659000 )
...
#### **7.2 三层交换机（Layer 3 Switch）**
 ...
 ![](https://img-blog.csdn.net/20130726175738687 )
 ...
 **7.2.1 使用三层交换机进行VLAN间路由（VLAN内通信）**
 ...
 ![](https://img-blog.csdn.net/20130726175831031 )
 ...
 **7.2.2 使用三层交换机进行VLAN间路由（VLAN间通信）**
 ...
 ![](https://img-blog.csdn.net/20130726175909406 )
...
#### **8.1 流（Flow）**
 ...
 ![](https://img-blog.csdn.net/20130726175938406 )
...
#### **8.2 加速VLAN间路由的机制**
 ...
 ![](https://img-blog.csdn.net/20130726180010687 )
...
#### **9.2 路由器和交换机配合构建LAN的实例**
 ...
 ![](https://img-blog.csdn.net/20130726180050656 )
...
#### **10.2 不使用VLAN的局域网中网络构成的改变**
 ...
 ![](https://img-blog.csdn.net/20130726180130125 )
...
#### **10.3 使用VLAN的局域网中网络构成的改变**
 ...
 ![](https://img-blog.csdn.net/20130726180206046 )
...
#### **10.4 利用VLAN而导致的网络结构复杂化**
 ...
 ![](https://img-blog.csdn.net/20130726180236218 )![](https://img-blog.csdn.net/20130726180236218 )
...
#### **10.5 网络的逻辑结构与物理结构**
 ...
 ![](https://img-blog.csdn.net/20130726180318750 )
 ...
 ![](https://img-blog.csdn.net/20130726180338921 )
